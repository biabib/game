...
void CGameStateRun::show_text_by_phase() {
	...
	if (team || sell) {
		...
		CTextDraw::Print(pDC, 50, 30, teamname[0]);
		CTextDraw::Print(pDC, 150, 30, pokemon[0]);
		CTextDraw::Print(pDC, 50, 100, teamname[1]);
		CTextDraw::Print(pDC, 150, 100, pokemon[1]);
		CTextDraw::Print(pDC, 50, 170, teamname[2]);
		CTextDraw::Print(pDC, 150, 170, pokemon[2]);
		CTextDraw::Print(pDC, 50, 240, teamname[3]);
		CTextDraw::Print(pDC, 150, 240, pokemon[3]);
		CTextDraw::Print(pDC, 50, 310, teamname[4]);
